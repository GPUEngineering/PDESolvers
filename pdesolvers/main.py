...
def main():
    ...
    numPointsSpace = 200  # x_points = y_points
    numPointsTime = 30  # t_points
    ts = 50
    ...
    # solution1.animate(#export=True,
    #                   filename="Explicit-Euler-100_spatial_pts")

    # solver2 = pde.Heat2DCNSolver(equation)
    # solution2 = solver2.solve()
    # solution2.animate(#export=True, 
    #                   filename="Crank-Nicolson-200_spatial_pts-CPU")

    # solver3 = pde.Heat2DCNSolverGPU(equation)
    # solution3 = solver3.solve()
    # solution3.animate(export=True,
    #                   filename="Crank-Nicolson-50_spatial_pts-gpu")

    # plot_frame(solution3, 1, export=True, filename="implicit-2_initial_condition")     # t=0
    # plot_frame(solution3, 5, export=True, filename="implicit-2_mid_evolution")        # Middle
    # plot_frame(solution3, 9, export=True, filename="implicit-2_final_state")        # Final
